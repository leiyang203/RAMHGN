...
def get_Fdataset_path(filename):
    for dataset_dir in ['./dataset/Fdataset', './dataset/F-dataset']:
        path = os.path.join(dataset_dir, filename)
        if os.path.exists(path):
            return path
    return os.path.join('./dataset/Fdataset', filename)
...
def load_Fdataset():
    """Load the drug-disease network of Fdataset.
    """

    drug_disease = pd.read_csv(get_Fdataset_path('drug_disease.csv'), header=None).values
    drug_drug = pd.read_csv(get_Fdataset_path('drug_drug.csv'), header=None).values
    disease_disease = pd.read_csv(get_Fdataset_path('disease_disease.csv'), header=None).values
